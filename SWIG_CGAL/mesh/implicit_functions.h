...
double cilinder (double x, double y, double z) {
    double x2=(x-0.2)*(x-0.2), y2=y*y, z2=z*z;
    return x2+z2-0.5;
}

typedef double (*ftr)(double x, double y, double z);
typedef std::function<double(double, double, double)> fptr;

fptr para (double x0, double y0, double z0) {
//    auto func = [=](double x, double y, double z) {
//        double x2=(x-x0)*(x-x0), y2=(y-y0)*(y-y0), z2=(z-z0)*(z-z0);
//        return x2+y2+z2-2;
//    };
